...
def _solve_ik_jax(
    ...
    costs = [
        pk.costs.pose_cost_analytic_jac(
            ...
            target_link_index,
            pos_weight=50.0,
            # SO-101 has only five pose DoF. Position must win when the
            # operator requests an orientation the arm cannot realize.
            ori_weight=2.0,
        ),
        pk.costs.rest_cost(joint_var, rest_pose, weight=0.05),
